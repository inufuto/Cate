...
internal class PointerLoadInstruction(Function function, AssignableOperand destinationOperand, Operand sourceOperand)
    : Cate.PointerLoadInstruction(function, destinationOperand, sourceOperand)
{
            ...
            if (!IsRegisterReserved(PointerRegister.Hl)) {
                if (SourceOperand is IntegerOperand integerOperand) {
                    using (PointerOperation.ReserveRegister(this, PointerRegister.Hl)) {
                        ...
                        PointerOperation.StoreConstantIndirect(this, PointerRegister.Hl, variableOperand.Offset,
